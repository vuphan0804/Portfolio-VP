...
const Header = () => {
  ...
  return (
    <div
      id="header"
      className={`flex z-20 top-0 left-0 right-0 fixed bg-gray-900 justify-between items-center h-24 text-textPrimary mx-auto px-10 transition-primary ${headerFixed}`}
    >
